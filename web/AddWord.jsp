                ...
                <div class="u-form u-form-1">
                    <form action="add" method="post" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" name="form" style="padding: 10px;">
                        ...
                        <div class="u-form-group u-form-name">
                            ...
                            <input type="text" value="${word}" placeholder="Enter word (if Vietnamese please include marks)" id="name-7b2e" name="word" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                        </div>
